document.addEventListener("DOMContentLoaded", () => {
    ...
    if (inventoryPage) {
        ...
        howToPlayButton.addEventListener("click", () => {
            console.log("How to Play button clicked"); // Debug log
            modal.classList.add("show"); // Add the 'show' class to make modal visible
        });

        // Close modal
        closeButton.addEventListener("click", () => {
            console.log("Close button clicked"); // Debug log
            modal.classList.remove("show"); // Remove the 'show' class to hide modal
        });
