...
RSpec.describe 'store/index.html.haml', type: :view do
  before do
    ...
    assign(:shards, [
             { name: '100 Shards', price: 0.99, description: 'A small shard, perfect for minor upgrades.',
               image: 'gem1.gif' },
             { name: '500 Shards', price: 3.00, description: 'A medium-sized shard, useful for moderate upgrades.',
               image: 'gem2.gif' },
             { name: '2500 Shards', price: 14.99, description: 'A large shard, ideal for powerful upgrades.',
               image: 'gem3.gif' }
           ])
    assign(:avatars, [
             { name: 'Avatar 1', price: 300, description: 'A warrior avatar with enhanced strength.',
               image: 'avatar_1.jpg' },
             { name: 'Avatar 2', price: 450, description: 'A mage avatar with powerful spells.', image: 'avatar_2.jpg' }
           ])
    assign(:consumables, [
             { name: 'Health Potion', price: 100, description: 'Restores health over time.',
