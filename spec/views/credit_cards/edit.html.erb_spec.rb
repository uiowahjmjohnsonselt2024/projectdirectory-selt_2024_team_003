...
RSpec.describe "credit_cards/edit.html.erb", type: :view do
  before do
  ...
  it "displays the form heading" do
    render
    expect(rendered).to have_selector("h1", text: "Edit Credit Card")
  end

  it "displays the form for editing a credit card" do
    render
  ...
  it "displays a label and text field for card number" do
    render
    expect(rendered).to have_selector("label", text: "New Card Number")
  ...
  it "displays a label and password field for CVV" do
    render
    expect(rendered).to have_selector("label", text: "New CVV")
  ...
  it "displays a label and number field for expiration month" do
    ...
    expect(rendered).to have_selector("input[type='number'][name='credit_card[expiration_month]'][min='1'][max='12']")
  end
  ...
  it "displays a submit button and back link" do
    ...
    expect(rendered).to have_selector("input[type='submit'][value='Update Card']")
  end
